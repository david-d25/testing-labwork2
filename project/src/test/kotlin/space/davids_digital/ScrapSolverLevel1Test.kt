...
class ScrapSolverLevel1Test {
    ...
    fun initMock() {
        ...
        `when`(basicMathMock.sin(-0.635 - 100*PERIOD)).thenReturn(-0.5931775143558129)
        ...
        `when`(basicMathMock.sin(-0.635 + PI/2 - 100*PERIOD)).thenReturn(0.8050716964734628)
        `when`(basicMathMock.sin(-0.8)).thenReturn(-0.7173560908995228)
        `when`(basicMathMock.sin(-0.8 - PERIOD)).thenReturn(-0.7173560908995228)
        `when`(basicMathMock.sin(-0.8 - 100*PERIOD)).thenReturn(-0.7173560908995228)
        ...
        `when`(basicMathMock.sin(-0.8 + PI/2 - 100*PERIOD)).thenReturn(0.6967067093471654)
        ...
        `when`(basicMathMock.sin(-1.8627 - 100*PERIOD)).thenReturn(-0.9576977799288106)
        ...
        `when`(basicMathMock.sin(-1.8627 + PI/2 - 100*PERIOD)).thenReturn(-0.2877758890515806)
        ...
        `when`(basicMathMock.sin(-1.8651 - 100*PERIOD)).thenReturn(-0.9570043602898399)
        ...
        `when`(basicMathMock.sin(-1.8651 + PI/2 - 100*PERIOD)).thenReturn(-0.29007353272271197)
        ...
        `when`(basicMathMock.sin(-1.8752 - 100*PERIOD)).thenReturn(-0.9540258558271397)
        ...
        `when`(basicMathMock.sin(-1.8752 + PI/2 - 100*PERIOD)).thenReturn(-0.2997243173539539)
        `when`(basicMathMock.sin(-2.6)).thenReturn(-0.5155013718214642)
        `when`(basicMathMock.sin(-2.6 - PERIOD)).thenReturn(-0.5155013718214642)
        `when`(basicMathMock.sin(-2.6 - 100*PERIOD)).thenReturn(-0.5155013718214642)
        ...
        `when`(basicMathMock.sin(-2.6 + PI/2 - 100*PERIOD)).thenReturn(-0.8568887533689473)
        ...
        `when`(basicMathMock.sin(-2.6416 - 100*PERIOD)).thenReturn(-0.4794190915097759)
        ...
        `when`(basicMathMock.sin(-2.6416 + PI/2 - 100*PERIOD)).thenReturn(-0.8775860839233615)
        ...
        `when`(basicMathMock.sin(-2.647 - 100*PERIOD)).thenReturn(-0.4746731597745568)
        ...
        `when`(basicMathMock.sin(-2.647 + PI/2 - 100*PERIOD)).thenReturn(-0.8801621392616465)
        ...
        `when`(basicMathMock.sin(-3.707 - 100*PERIOD)).thenReturn(0.5357598117150862)
        ...
        `when`(basicMathMock.sin(-3.707 + PI/2 - 100*PERIOD)).thenReturn(-0.8443704306470089)
        ...
        `when`(basicMathMock.sin(-3.739 - 100*PERIOD)).thenReturn(0.5625007687268155)
        `when`(basicMathMock.sin(-3.739 + PI/2)).thenReturn(-0.8267967617145954)
        `when`(basicMathMock.sin(-3.739 + PI/2 - PERIOD)).thenReturn(-0.8267967617145954)
        `when`(basicMathMock.sin(-3.739 + PI/2 - 100*PERIOD)).thenReturn(-0.8267967617145954)
        ...
        `when`(basicMathMock.sin(-5.142 - 100*PERIOD)).thenReturn(0.9091278354700241)
        ...
        `when`(basicMathMock.sin(-5.142 + PI/2 - 100*PERIOD)).thenReturn(0.41651720105367673)
        ...
        `when`(basicMathMock.sin(-5.147 - 100*PERIOD)).thenReturn(0.9070338940679183)
        ...
        `when`(basicMathMock.sin(-5.147 + PI/2 - 100*PERIOD)).thenReturn(0.42105761483672083)
        ...
        `when`(basicMathMock.sin(-5.165 - 100*PERIOD)).thenReturn(0.8993083307387134)
        `when`(basicMathMock.sin(-5.165 + PI/2)).thenReturn(0.4373151338153631)
        `when`(basicMathMock.sin(-5.165 + PI/2 - PERIOD)).thenReturn(0.4373151338153631)
        `when`(basicMathMock.sin(-5.165 + PI/2 - 100*PERIOD)).thenReturn(0.4373151338153631)
        `when`(basicMathMock.sin(-5.6)).thenReturn(0.6312666378723216)
        `when`(basicMathMock.sin(-5.6 - PERIOD)).thenReturn(0.6312666378723216)
        `when`(basicMathMock.sin(-5.6 - 100*PERIOD)).thenReturn(0.6312666378723216)
        ...
        `when`(basicMathMock.sin(-5.6 + PI/2 - 100*PERIOD)).thenReturn(0.7755658785102496)
        ...
        `when`(basicMathMock.sin(-5.732 - 100*PERIOD)).thenReturn(0.5236973649553304)
        `when`(basicMathMock.sin(-5.732 + PI/2)).thenReturn(0.851904378401029)
        `when`(basicMathMock.sin(-5.732 + PI/2 - PERIOD)).thenReturn(0.851904378401029)
        `when`(basicMathMock.sin(-5.732 + PI/2 - 100*PERIOD)).thenReturn(0.851904378401029)
        ...
        `when`(basicMathMock.sin(-5.796 - 100*PERIOD)).thenReturn(0.46814053122350874)
        ...
        `when`(basicMathMock.sin(-5.796 + PI/2 - 100*PERIOD)).thenReturn(0.8836540290327267)
        ...
        `when`(basicMathMock.sin(-5.8 - 100*PERIOD)).thenReturn(0.46460217941375737)
        ...
        `when`(basicMathMock.sin(-5.8 + PI/2 - 100*PERIOD)).thenReturn(0.8855195169413189)
        ...
        `when`(basicMathMock.sin(-5.804 - 100*PERIOD)).thenReturn(0.4610563939790461)
        ...
        `when`(basicMathMock.sin(-PI - 100*PERIOD)).thenReturn(-1.2246467991473532E-16)
        `when`(basicMathMock.sin(-PI + PI/2)).thenReturn(-1.0)
        `when`(basicMathMock.sin(-PI + PI/2 - PERIOD)).thenReturn(-1.0)
        `when`(basicMathMock.sin(-PI + PI/2 - 100*PERIOD)).thenReturn(-1.0)
        `when`(basicMathMock.sin(-PI)).thenReturn(-1.2246467991473532E-16)
        `when`(basicMathMock.sin(-PI - PERIOD)).thenReturn(-1.2246467991473532E-16)
        `when`(basicMathMock.sin(-PI - 100*PERIOD)).thenReturn(-1.2246467991473532E-16)
        `when`(basicMathMock.sin(-PI + PI/2)).thenReturn(-1.0)
        ...
        `when`(basicMathMock.sin(-0.717 - 100*PERIOD)).thenReturn(-0.6571262909383763)
        ...
        `when`(basicMathMock.sin(-0.717 + PI/2 - 100*PERIOD)).thenReturn(0.7537804970663359)
        ...
        `when`(basicMathMock.sin(-1.867 - 100*PERIOD)).thenReturn(-0.9564514935169185)
        ...
        `when`(basicMathMock.sin(-1.867 + PI/2 - 100*PERIOD)).thenReturn(-0.29189131633067833)
        ...
        `when`(basicMathMock.sin(-2.363 - 100*PERIOD)).thenReturn(-0.7022782214490862)
        ...
        `when`(basicMathMock.sin(-2.363 + PI/2 - 100*PERIOD)).thenReturn(-0.711902591425476)
        ...
        `when`(basicMathMock.sin(-2.637 - 100*PERIOD)).thenReturn(-0.4834509010140078)
        ...
        `when`(basicMathMock.sin(-2.637 + PI/2 - 100*PERIOD)).thenReturn(-0.8753714790354687)
        ...
        `when`(basicMathMock.sin(-5.151 - 100*PERIOD)).thenReturn(0.9053424118383717)
        `when`(basicMathMock.sin(-5.151 + PI/2)).thenReturn(0.4246823722815442)
        `when`(basicMathMock.sin(-5.151 + PI/2 - PERIOD)).thenReturn(0.4246823722815442)
        `when`(basicMathMock.sin(-5.151 + PI/2 - 100*PERIOD)).thenReturn(0.4246823722815442)
        ...
        `when`(basicMathMock.sin(-5.507 - 100*PERIOD)).thenReturn(0.7005623919951497)
        ...
        `when`(basicMathMock.sin(-5.507 + PI/2 - 100*PERIOD)).thenReturn(0.713591153898389)
        ...
        `when`(basicMathMock.sin(-5.685 - 100*PERIOD)).thenReturn(0.5631438138876175)
        `when`(basicMathMock.sin(-5.685 + PI/2)).thenReturn(0.8263589080297425)
        `when`(basicMathMock.sin(-5.685 + PI/2 - PERIOD)).thenReturn(0.8263589080297425)
        `when`(basicMathMock.sin(-5.685 + PI/2 - 100*PERIOD)).thenReturn(0.8263589080297425)
        ...
        `when`(basicMathMock.sin(-5.797 - 100*PERIOD)).thenReturn(0.46725664327150607)
        ...
        `when`(basicMathMock.sin(-5.797 + PI/2 - 100*PERIOD)).thenReturn(0.8841217276589489)
        ...
        `when`(basicMathMock.sin(-5.801 - 100*PERIOD)).thenReturn(0.463716427743332)
        ...
        `when`(basicMathMock.sin(-5.801 + PI/2 - 100*PERIOD)).thenReturn(0.8859836762835775)
        ...
        `when`(basicMathMock.sin(-1.864 - 100*PERIOD)).thenReturn(-0.9573228621239073)
        `when`(basicMathMock.sin(-1.864 + PI/2)).thenReturn(-0.2890206526442191)
        `when`(basicMathMock.sin(-1.864 + PI/2 - PERIOD)).thenReturn(-0.2890206526442191)
        `when`(basicMathMock.sin(-1.864 + PI/2 - 100*PERIOD)).thenReturn(-0.2890206526442191)
        ...
        `when`(basicMathMock.sin(-2.643 - 100*PERIOD)).thenReturn(-0.47819000156299973)
        `when`(basicMathMock.sin(-2.643 + PI/2)).thenReturn(-0.878256410397999)
        `when`(basicMathMock.sin(-2.643 + PI/2 - PERIOD)).thenReturn(-0.878256410397999)
        `when`(basicMathMock.sin(-2.643 + PI/2 - 100*PERIOD)).thenReturn(-0.878256410397999)
        ...
        `when`(basicMathMock.sin(-3.72 - 100*PERIOD)).thenReturn(0.5466910470692872)
        ...
        `when`(basicMathMock.sin(-3.72 + PI/2 - 100*PERIOD)).thenReturn(-0.8373344009738799)
        ...
        `when`(basicMathMock.sin(-5.145 - 100*PERIOD)).thenReturn(0.9078741946689985)
        ...
        `when`(basicMathMock.sin(-5.145 + PI/2 - 100*PERIOD)).thenReturn(0.4192427061430137)
        `when`(basicMathMock.sin(-5.801)).thenReturn(0.463716427743332)
        `when`(basicMathMock.sin(-5.801 - PERIOD)).thenReturn(0.463716427743332)
        `when`(basicMathMock.sin(-5.801 - 100*PERIOD)).thenReturn(0.463716427743332)
        `when`(basicMathMock.sin(-5.801 + PI/2)).thenReturn(0.8859836762835775)
        ...
        `when`(basicMathMock.sin(0.0 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-9.999999999999982E-8)
        `when`(basicMathMock.sin(0.0 + NEIGHBORHOOD_DELTA)).thenReturn(9.999999999999982E-8)
        `when`(basicMathMock.sin(0.0 + NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(9.999999999999982E-8)
        `when`(basicMathMock.sin(0.0 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(9.999999999999982E-8)
        ...
        `when`(basicMathMock.sin(0.0 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.999999999999995)
        `when`(basicMathMock.sin(0.0 + PI/2 + NEIGHBORHOOD_DELTA)).thenReturn(0.999999999999995)
        `when`(basicMathMock.sin(0.0 + PI/2 + NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(0.999999999999995)
        `when`(basicMathMock.sin(0.0 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.999999999999995)
        ...
        `when`(basicMathMock.sin(-PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.999999999999995)
        `when`(basicMathMock.sin(-PI/2 + NEIGHBORHOOD_DELTA)).thenReturn(-0.999999999999995)
        `when`(basicMathMock.sin(-PI/2 + NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(-0.999999999999995)
        `when`(basicMathMock.sin(-PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.999999999999995)
        ...
        `when`(basicMathMock.sin(-PI/2 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-9.999999999999982E-8)
        `when`(basicMathMock.sin(-PI/2 + PI/2 + NEIGHBORHOOD_DELTA)).thenReturn(9.999999999999982E-8)
        `when`(basicMathMock.sin(-PI/2 + PI/2 + NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(9.999999999999982E-8)
        `when`(basicMathMock.sin(-PI/2 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(9.999999999999982E-8)
        ...
        `when`(basicMathMock.sin(-PI - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(9.999999971387727E-8)
        ...
        `when`(basicMathMock.sin(-PI + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-9.999999995880663E-8)
        ...
        `when`(basicMathMock.sin(-PI + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.999999999999995)
        `when`(basicMathMock.sin(-PI + PI/2 + NEIGHBORHOOD_DELTA)).thenReturn(-0.999999999999995)
        `when`(basicMathMock.sin(-PI + PI/2 + NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(-0.999999999999995)
        `when`(basicMathMock.sin(-PI + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.999999999999995)
        `when`(basicMathMock.sin(-PI - NEIGHBORHOOD_DELTA)).thenReturn(9.999999971387727E-8)
        ...
        `when`(basicMathMock.sin(-0.717 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.6571263663164226)
        ...
        `when`(basicMathMock.sin(-0.717 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.6571262155603234)
        ...
        `when`(basicMathMock.sin(-0.717 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.7537804313537031)
        ...
        `when`(basicMathMock.sin(-0.717 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.7537805627789612)
        ...
        `when`(basicMathMock.sin(-1.867 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.956451464327782)
        ...
        `when`(basicMathMock.sin(-1.867 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.9564515227060453)
        ...
        `when`(basicMathMock.sin(-1.867 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.29189141197582624)
        ...
        `when`(basicMathMock.sin(-1.867 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.29189122068552753)
        ...
        `when`(basicMathMock.sin(-2.363 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.7022781502588237)
        ...
        `when`(basicMathMock.sin(-2.363 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.7022782926393417)
        ...
        `when`(basicMathMock.sin(-2.363 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.7119026616532945)
        ...
        `when`(basicMathMock.sin(-2.363 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.7119025211976503)
        ...
        `when`(basicMathMock.sin(-2.637 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.4834508134768576)
        ...
        `when`(basicMathMock.sin(-2.637 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.4834509885511531)
        ...
        `when`(basicMathMock.sin(-2.637 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.8753715273805545)
        ...
        `when`(basicMathMock.sin(-2.637 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(-0.8753714306903743)
        ...
        `when`(basicMathMock.sin(-5.151 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.9053423693701299)
        ...
        `when`(basicMathMock.sin(-5.151 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.9053424543066045)
        `when`(basicMathMock.sin(-5.151 + PI/2 - NEIGHBORHOOD_DELTA)).thenReturn(0.42468246281578315)
        `when`(basicMathMock.sin(-5.151 + PI/2 - NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(0.42468246281578315)
        `when`(basicMathMock.sin(-5.151 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.42468246281578315)
        `when`(basicMathMock.sin(-5.151 + PI/2 + NEIGHBORHOOD_DELTA)).thenReturn(0.42468228174730105)
        `when`(basicMathMock.sin(-5.151 + PI/2 + NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(0.42468228174730105)
        `when`(basicMathMock.sin(-5.151 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.42468228174730105)
        ...
        `when`(basicMathMock.sin(-5.507 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.7005623206360305)
        ...
        `when`(basicMathMock.sin(-5.507 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.7005624633542618)
        `when`(basicMathMock.sin(-5.507 + PI/2 - NEIGHBORHOOD_DELTA)).thenReturn(0.7135912239546245)
        `when`(basicMathMock.sin(-5.507 + PI/2 - NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(0.7135912239546245)
        `when`(basicMathMock.sin(-5.507 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.7135912239546245)
        `when`(basicMathMock.sin(-5.507 + PI/2 + NEIGHBORHOOD_DELTA)).thenReturn(0.7135910838421463)
        `when`(basicMathMock.sin(-5.507 + PI/2 + NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(0.7135910838421463)
        `when`(basicMathMock.sin(-5.507 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.7135910838421463)
        ...
        `when`(basicMathMock.sin(-5.685 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.5631437312517237)
        ...
        `when`(basicMathMock.sin(-5.685 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.5631438965235057)
        ...
        `when`(basicMathMock.sin(-5.685 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.8263589643441199)
        ...
        `when`(basicMathMock.sin(-5.685 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.8263588517153568)
        ...
        `when`(basicMathMock.sin(-5.797 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.4672565548593307)
        ...
        `when`(basicMathMock.sin(-5.797 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.46725673168367676)
        ...
        `when`(basicMathMock.sin(-5.797 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.8841217743846089)
        ...
        `when`(basicMathMock.sin(-5.797 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.88412168093328)
        ...
        `when`(basicMathMock.sin(-5.801 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.4637163391449618)
        ...
        `when`(basicMathMock.sin(-5.801 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.4637165163416975)
        ...
        `when`(basicMathMock.sin(-5.801 + PI/2 - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.8859837226552161)
        ...
        `when`(basicMathMock.sin(-5.801 + PI/2 + NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(0.8859836299119302)
