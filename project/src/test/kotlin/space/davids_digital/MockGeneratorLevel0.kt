...
fun main() {
    ...
    for (x in asymptotesPeriodic + extremesPeriodic) {
        ...
        println("`when`(mathMock.cos(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(cos(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.tan(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(tan(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.cot(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(1/ tan(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.sec(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(1/ cos(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.csc(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(1/ sin(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.sin(${format(x)} - NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(${format(sin(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.cos(${format(x)} - NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(${format(cos(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.tan(${format(x)} - NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(${format(tan(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.cot(${format(x)} - NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(${format(1/ tan(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.sec(${format(x)} - NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(${format(1/ cos(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.csc(${format(x)} - NEIGHBORHOOD_DELTA - PERIOD)).thenReturn(${format(1/ sin(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.sin(${format(x)} - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(${format(sin(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.cos(${format(x)} - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(${format(cos(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.tan(${format(x)} - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(${format(tan(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.cot(${format(x)} - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(${format(1/ tan(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.sec(${format(x)} - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(${format(1/ cos(x - NEIGHBORHOOD_DELTA))})")
        println("`when`(mathMock.csc(${format(x)} - NEIGHBORHOOD_DELTA - 100*PERIOD)).thenReturn(${format(1/ sin(x - NEIGHBORHOOD_DELTA))})")
    ...
    println("`when`(mathMock.log2(0.0 + NEIGHBORHOOD_DELTA)).thenReturn(${format(log(NEIGHBORHOOD_DELTA, 2.0))})")
    println("`when`(mathMock.log3(0.0 + NEIGHBORHOOD_DELTA)).thenReturn(${format(log(NEIGHBORHOOD_DELTA, 3.0))})")
    println("`when`(mathMock.log5(0.0 + NEIGHBORHOOD_DELTA)).thenReturn(${format(log(NEIGHBORHOOD_DELTA, 5.0))})")
    println("`when`(mathMock.log10(0.0 + NEIGHBORHOOD_DELTA)).thenReturn(${format(log(NEIGHBORHOOD_DELTA, 10.0))})")
    ...
    for (x in extremes + zeroes) {
        ...
        println("`when`(mathMock.log2(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(log(x - NEIGHBORHOOD_DELTA, 2.0))})")
        println("`when`(mathMock.log3(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(log(x - NEIGHBORHOOD_DELTA, 3.0))})")
        println("`when`(mathMock.log5(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(log(x - NEIGHBORHOOD_DELTA, 5.0))})")
        println("`when`(mathMock.log10(${format(x)} - NEIGHBORHOOD_DELTA)).thenReturn(${format(log(x - NEIGHBORHOOD_DELTA, 10.0))})")
